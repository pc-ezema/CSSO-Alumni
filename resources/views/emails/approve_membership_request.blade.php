                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" style="padding: 20px 30px 20px 10px; color: #000; border-top: none; border-bottom: none; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
							<p>Welcome to C.S.S.O OBOSI ALUMNI ASSOCIATION.</p>
							<p>Below is your login details:</p>
							<p>Membership ID: <b style="color: #264774">{{$membership_id}}</b></p>
							<p>Password: <b style="color: #264774">Password</b></p>
                        </td>
                    </tr>		
                    <tr>
                        <td bgcolor="#ffffff" align="left" style="border-top: 1px solid #264774; padding: 10px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #000; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
